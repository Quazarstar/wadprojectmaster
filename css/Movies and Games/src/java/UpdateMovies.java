 ...
 * @author eidolon
 */
@WebServlet(name="UpdateMovies", urlPatterns={"/UpdateMovies"})
    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           // Database database = (Database) cl.newInstance();
            ...
            // get the collection
           // Collection col = DatabaseManager.getCollection(URI + "/db/furnitureStore");


            //col.setProperty(OutputKeys.INDENT, "no");
            //res = (XMLResource)col.getResource("products.xml");
        ...
        try {
            ...
            transformer.setParameter("vProduct_id", product_id);
