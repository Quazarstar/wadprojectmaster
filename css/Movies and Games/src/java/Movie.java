...
public class Movie extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            // File Info
            String xmlPath = getServletContext().getRealPath("/xml/");
            String xslPath = getServletContext().getRealPath("/xsl/");
            String XMLFileName = xmlPath + "/store.xml";
            String XSLFileName = xslPath + "/movie.xsl";

            // Get Query String Param
            String eventName = request.getParameter("movie");
            ...
            // Get Navigation Info
            NodeList eventNodeList = doc.getElementsByTagName("movie");
            ...
            for (int i=0;i<num_events; i++){
                ...
                String eventNameValue = nameTextNode.getNodeValue();
                 ...
                 if (eventName.equals(eventNameValue)) {
                    ...
                    // Apply transform
                    optimusPrime.setParameter("currentMovie", eventName);
                    optimusPrime.setParameter("nextMovie", next_name);
                    optimusPrime.setParameter("prevMovie", prev_name);
